<script lang="ts">
    ...
    import { showVictory, isPaused, timer, solver, bestTime, curIsBest, renderIdx, showRestart, selectedNumber, selectedSubCellId, inNoteMode, initialSelect, ctrlNumSelected, errorsList } from "../../stores";
    ...
    <div class="backdrop">
        <div class="modal" on:click|stopPropagation="{()=>{}}">
            <div class="content">
                ...
                <div style="font-size: 16px; margin-bottom: 7px;">Difficulty: {capitalizeFirstLetter($solver.curDif)}</div>
                {#if $bestTime}
                    {#if $curIsBest}
